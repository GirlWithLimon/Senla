...
public class Operation {
    private final Stok stok = new Stok();
    private final IBookStok bookStok = stok;
    private final IShowBook bookShow = stok;
    private final IOrderOperation orderOperation = stok;
    ...
    public void showOldBooksSortedByDate() {
        List<BookCopy> oldBooks = stok.getOldBooksSortedByDate();
    ...
    public void showOldBooksSortedByPrice() {
        List<BookCopy> oldBooks = stok.getOldBooksSortedByPrice();
